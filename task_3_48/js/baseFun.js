...
var FUN = {
	...
	getPos : function (e) {
		...
		return [parseInt(width / 20 + 1), parseInt((height - 30) / 20 + 1)];
	},
	...
	getSizeByPos : function () {
		return [parseInt(window.document.documentElement.clientWidth / 20), parseInt((window.document.documentElement.clientHeight - 70) / 20)];
	}
